...
public class Query {
	...
	{
		int rank=0;
		PrintWriter out= new PrintWriter(new BufferedWriter(new FileWriter("LM_StopAndStemIndex.txt",true)));
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		stopWordsFile();
		readIndex("C://Users//vikas//Documents//GitHub//InformationRetreival//InformationRetreival//IR_HW_2//IndexwithStopAndStem.txt");
		File queryFile = new File("C://Users//vikas//Documents//GitHub//InformationRetreival//InformationRetreival//IR_HW_2//queryMainFile.txt");
